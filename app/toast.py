...
KIND_STYLES = {
    ...
    "success": {"accent": "#1b7f3b", "icon": "\u2713", "duration": 4000},
    "error": {"accent": "#b3261e", "icon": "\u00d7", "duration": 9000},
    "warning": {"accent": "#b45309", "icon": "!", "duration": 6000},
    "info": {"accent": "#34558b", "icon": "i", "duration": 4000},
}
...
class CloseButton(QPushButton):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self._color = QColor("#9aa1ad")
        self._hover = QColor("#4b5563")
...
class ToastItem(QFrame):
    ...
    def __init__(self, message: str, kind: str, duration_ms: int | None, parent=None) -> None:
        ...
        self.setStyleSheet(
            "QFrame#toastCard { background: #ffffff; border: 1px solid #e3e7ee;"
            " border-radius: 10px; }"
            "QFrame#toastAccent { border-top-left-radius: 10px;"
            " border-bottom-left-radius: 10px; }"
            "QLabel#toastText { color: #374151; font-size: 12px; background: transparent; }"
        )
